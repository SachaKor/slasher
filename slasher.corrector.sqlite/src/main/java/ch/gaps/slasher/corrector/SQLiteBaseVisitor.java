...
// Generated from /Users/Sashok/Documents/2017-2018/Stage/slasher/slasher.corrector.sqlite/src/main/antlr/ch/gaps/slasher/corrector/SQLite.g4 by ANTLR 4.7
...
public class SQLiteBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SQLiteVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitSelect_core(SQLiteParser.Select_coreContext ctx) throws SQLException { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
